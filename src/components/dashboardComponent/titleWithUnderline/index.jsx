...
const TitleWithUnderline = ({ title }) => {
  return (
    <div className="relative inline-block text-center">
      <h2 className="titleWithUnderline text-3xl font-bold z-10 relative">{title}</h2>
      <svg
        className="twu_underline absolute left-0 top-full w-full h-6 pointer-events-none"
