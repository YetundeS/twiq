              ...
              <div className="rounded-full border border-gray-200 bg-white bg-white/95 p-4 shadow-2xl backdrop-blur-md dark:border-gray-700 dark:bg-gray-800 dark:bg-gray-800/95">
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className="flex-1 resize-none border-0 bg-transparent focus:border-0 focus:ring-0"
                  />
                  <Button
                    size="icon"
                    className="h-8 w-8 flex-shrink-0 cursor-pointer rounded-xl bg-purple-600 transition-all duration-200 hover:scale-105 hover:bg-purple-700 dark:bg-purple-500 dark:hover:bg-purple-600"
                  >
